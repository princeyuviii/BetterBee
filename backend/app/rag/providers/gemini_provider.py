...
class GeminiProvider(LLMProvider):
    """Cloud Gemini LLM Provider using langchain-google-genai."""
    ...
    def __init__(self, model: str, api_key: str | None, **kwargs) -> None:
        ...
        logger.info("Gemini LLM provider initialized", model=model)
    ...
    async def generate(self, messages: list[dict[str, str]], **kwargs) -> str:
        ...
        try:
            ...
            logger.error("Gemini generation failed", error=str(e), model=self.model)
    ...
    async def stream(self, messages: list[dict[str, str]], **kwargs) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            logger.error("Gemini streaming failed", error=str(e), model=self.model)
            from app.core.exceptions import ProviderError
            raise ProviderError("Gemini", str(e))
